...
namespace A19_Nadav_308426048_David_311338016
{
    class Login
    {
        ...
        static readonly string[] r_Permissions = { "email", "user_photos" };//, "user_likes", "user_birthday", "user_friends", "user_posts", "user_photos", "user_events", "publish_to_groups", "manage_pages", "publish_pages" };//"publish_stream", "user_groups" };
